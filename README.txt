...
signatures using automatically rotated random keys.  Usage example::
...
more secure than AES-256), signs it using SHA-256, and encodes
...
keys may be stored on a shared volume using NFS.  With a little work, the
keys could be stored in a key-value store such as MongoDB.
